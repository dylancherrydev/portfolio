    ...
    <body class="md:text bg-gray-800">
      <div class="p-16 text-center">
        ...
        <div class="md:flex space-x-4 pt-12 ">
          ...
          <div>
            <img src="https://res.cloudinary.com/dploqe2ts/image/upload/v1633016623/T02NE0241-U026Z2X2YV7-a31615815abe-512_tfvvjs.png" alt="Portrait of Dylan Cherry" class="rounded-md"></img>
          </div>
        </div>
      </div>
